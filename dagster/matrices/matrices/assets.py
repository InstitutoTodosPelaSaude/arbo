...
@asset(
    ...
    deps=[
        ...
        get_asset_key_for_model([arboviroses_dbt_assets], "02_DENV_line_bar_posrate_posneg_direct_week_country_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "02_DENV_line_bar_posrate_posneg_direct_week_country_r"),
        ...
        get_asset_key_for_model([arboviroses_dbt_assets], "07_DENV_barH_pos_agegroups_month_country_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "07_DENV_barH_pos_agegroups_month_country_r"),
        get_asset_key_for_model([arboviroses_dbt_assets], "08_Arbo_barH_pos_agegroups_month_country_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "08_Arbo_barH_pos_agegroups_month_country_r"),
        get_asset_key_for_model([arboviroses_dbt_assets], "11_DENV_map_pos_direct_states_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "11_DENV_map_pos_direct_states_r"),
        get_asset_key_for_model([arboviroses_dbt_assets], "11_DENV_map_pos_direct_cities_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "11_DENV_map_pos_direct_cities_r"),
        get_asset_key_for_model([arboviroses_dbt_assets], "12_CHIKV_map_pos_direct_states_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "12_CHIKV_map_pos_direct_states_r"),
        get_asset_key_for_model([arboviroses_dbt_assets], "12_CHIKV_map_pos_direct_cities_h"),
        get_asset_key_for_model([arboviroses_dbt_assets], "12_CHIKV_map_pos_direct_cities_r"),
...
def export_matrices_to_xlsx(context):
    ...
    matrix_tables = ['01_DENV_line_posrate_direct_week_country_years',
                     '02_DENV_line_bar_posrate_posneg_direct_week_country_h',
                     '02_DENV_line_bar_posrate_posneg_direct_week_country_r',
                     ...
                     '07_DENV_barH_pos_agegroups_month_country_h',
                     '07_DENV_barH_pos_agegroups_month_country_r',
                     '08_Arbo_barH_pos_agegroups_month_country_h',
                     '08_Arbo_barH_pos_agegroups_month_country_r',
                     '11_DENV_map_pos_direct_states_h',
                     '11_DENV_map_pos_direct_states_r',
                     '11_DENV_map_pos_direct_cities_h',
                     '11_DENV_map_pos_direct_cities_r', 
                     '12_CHIKV_map_pos_direct_states_h', 
                     '12_CHIKV_map_pos_direct_states_r',
                     '12_CHIKV_map_pos_direct_cities_h',
                     '12_CHIKV_map_pos_direct_cities_r',
