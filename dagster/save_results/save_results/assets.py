...
REPORTS_FILES_FOLDER = "/data/arbo/reports/"
REPORTS_CURRENT_FILES_FOLDER = "/data/arbo/reports/current/"
...
SLACK_SUCCESS_MESSAGE_DELAY_MINUTES = 15
...
def create_new_folder(context):
    ...
    folder_name = f'{date}_Arbo_{epiweek_number}_V{version}'
...
def save_combined_files(context):
    ...
    file_system = FileSystem(root_path='/data/arbo/')
...
def save_public_matrices(context):
    ...
    data_file_system = FileSystem(root_path='/data/arbo/')
    public_file_system = FileSystem(root_path='/public/arbo/')
