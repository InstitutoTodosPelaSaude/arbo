...
EINSTEIN_FILES_FOLDER = "/data/arbo/data/einstein/"
...
def einstein_raw(context):
    ...
    einstein_df = pd.read_excel(file_system.get_file_content_as_io_bytes(file_to_get), dtype = str, sheet_name='itps_dengue')
